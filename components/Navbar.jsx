...
const Navbar = () => {
  ...
  return (
    <header className="py-4 px-6 md:px-12 lg:px-[7.5rem] w-full fixed top-0 z-50 bg-white/70 dark:bg-black/70 backdrop-blur-sm border-b-2 border-black dark:border-white">
